...
public class SerializeUtils {
    ...
    public static Record deserializeResponse(int op, byte[] data, ReplyHeader header) throws IOException {
        ...
        switch (op) {
            ...
            case OpCode.getChildren2:
                response = new GetChildren2Response();
                break;
            case OpCode.getACL:
                response = new GetACLResponse();
                break;
            default:
                throw new IOException("Unsupported Txn with type=" + op);
        }
        if (response != null) {
            response.deserialize(ia, "response");
        }
        return response;
    }
