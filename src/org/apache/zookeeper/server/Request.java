...
public class Request {
    ...
    public int cid;
    // request originally from cluster id (default is self)
    public int from = Config.instance().getClusterID();
    // sending tokens, used within server only
    //public List<String> paths;
    public TreeMap<String, TokenType> sending;
