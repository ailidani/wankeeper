...
public class ZKDatabase {
    ...
    /**
     * the filetxnsnaplog that this leader database
    ...
    /**
     * checks to see if the leader database has been
     * initialized or not.
     * @return true if leader database is initialized and false if not
     */
    ...
    /**
     * the committed log for this leader database
     ...
     * @param zxid the zxid to truncate leader database to
