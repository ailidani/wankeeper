...
public class LeaderZooKeeperServer extends QuorumZooKeeperServer {
    ...
    protected PrepRequestProcessor prepRequestProcessor;
     ...
     * @throws IOException
     */
    // FIXME changed from default to protected
    protected LeaderZooKeeperServer(FileTxnSnapLog logFactory, QuorumPeer self, ZKDatabase zkDb) throws IOException {
    ...
    protected synchronized void setupContainerManager() {
